...
Echo.&Echo  4.移除IE右鍵下載菜單 (預設)
Echo.&Echo  5.啟用邊下邊播功能 (自選)
Echo.&Echo  6.禁用邊下邊播功能 (預設)
Echo.&Echo  7.啟用谷歌流覽器擴展支持 (自選)
Echo.&Echo  8.禁用谷歌流覽器擴展支持 (預設)
...
Reg Add HKCR\Xunlei.Bittorrent.6\Shell\Open /ve /d "使用迅雷下載該BT檔" /F>NUL
...
Reg Add HKCR\Xunlei.LSTFile.6\Shell\Open /ve /d "使用迅雷下載該任務列表檔" /F>NUL
...
Reg Add HKCR\Xunlei.TDFile.6\Shell\Open /ve /d "使用迅雷下載未完成檔" /F>NUL
...
Echo.&Echo 已啟用擴展支援，您需從谷歌網上應用店安裝官方擴展，方可正常使用！
